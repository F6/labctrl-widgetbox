...
export const useConnectionInfoStore = defineStore(
  "spectrometer-fx2000-widgetbox-connection-info",
  () => {
    const connInfoState: RemovableRef<ConnectionInfoState> = useStorage(
      "spectrometer-fx2000-widgetbox-connection-info-local-storage",
      {
        restful: {
          protocol: "http://",
          host: "",
...
export const useConnectionStatusStore = defineStore(
  "spectrometer-fx2000-widgetbox-connection-status",
  () => {
...
export const useWebSocketManagerStore = defineStore(
  "spectrometer-fx2000-widgetbox-websocket-manager",
  () => {
